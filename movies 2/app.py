...
app = Flask(__name__)
app.secret_key = 'yazen'
#The line app.secret_key = 'yazen' sets the secret key for the Flask
#application. The secret key is used for encrypting session data and other security-related purposes

...
class Test_Cases(BaseClass):
    ...
    def test_movie_page1(self, setup):
        ...
        driver.find_element(By.XPATH, "//input[@id='username']").send_keys("yazen")
        driver.find_element(By.XPATH, "//input[@id='password']").send_keys("yazen")
        driver.find_element(By.XPATH, "//input[@type='submit']").click()
        add_movie_link = driver.find_element(By.CSS_SELECTOR, "a[href='/addMovie']")
        text = add_movie_link.text
    ...
    def test_security_movies2(self, setup):
        ...
        username_field = driver.find_element(By.XPATH, "//input[@id='username']").send_keys("yazen")
        password_field = driver.find_element(By.XPATH, "//input[@id='password']").send_keys("yazen")

        assert username_field, "Username field is not present"
        assert password_field, "Password field is not present"
        username_field.send_keys("yazen")
        password_field.send_keys("yazen")
        login_button = driver.find_element(By.XPATH, "//input[@type='submit']").click()
    ...
    def test_invalid_login(self, setup):
        ...
        driver.get('http://127.0.0.1:5000/')
        driver.find_element(By.XPATH, "//input[@id='username']").send_keys("yazen")
        driver.find_element(By.XPATH, "//input[@id='password']").send_keys("yazens")
        driver.find_element(By.XPATH, "//input[@type='submit']").click()
    ...
    def test_signup(self, setup):
        ...
        driver.find_element(By.XPATH, "//input[@id='username']").send_keys("testsignup")
        driver.find_element(By.XPATH, "//input[@id='password']").send_keys("testsignup")
    ...
    def test_movie_details(self, setup):
        ...
        driver.get('http://127.0.0.1:5000/')
        driver.find_element(By.CSS_SELECTOR, "//input[@id='username']").send_keys("yazen")
        driver.find_element(By.XPATH, "//input[@id='password']").send_keys("yazen")
    ...
    def test_user_signup(self, setup):
        ...
        driver.find_element(By.XPATH, "//input[@id='username']").send_keys("testusersignup3")
        driver.find_element(By.XPATH, "//input[@id='password']").send_keys("testsignup3")
        driver.find_element(By.XPATH, "//input[@value='signup']").click()
    ...
    def test_user_signup(self, setup):
        ...
        logger = self.getLogger()
        driver.get('http://127.0.0.1:5000/signup')
        driver.find_element(By.XPATH, "//input[@id='username']").send_keys("testsignup33")
        driver.find_element(By.XPATH, "//input[@id='password']").send_keys("testsignup33")
        driver.find_element(By.XPATH, "//input[@value='Signup']").click()
    ...
    def test_user_login(self, setup):
        ...
        driver.find_element(By.XPATH, "//input[@id='password']").send_keys("yazen")
        driver.find_element(By.XPATH, "input[value='Login']").click()
        assert "index" in driver.current_url, "Login process failed"
